...
export const PlayCircleIcon = ({ size = 24, width, height, isPlaying, ...props }) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
  ...
  >
    {isPlaying ? (
      ...
      <path
        d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-3 14.857V7.143L16.658 12 9 16.857z"
        fill="currentColor"
      />
    )}
  </svg>
